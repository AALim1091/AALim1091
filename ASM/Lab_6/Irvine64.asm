...
; Modified by Adrian Nastase 9/24/2014
; Modification notes: 
; 1. In ReadString pushed rdx before the API call ReadConsoleA. Then poped it after the call. 
;	 In Win 7 64-bit, on a 64-bit machine, the API call modifies rdx and the app crashes. 
;	 Mods are at lines 404, 406, 449, 451 
;
; 2. Added to WriteInt64 rax in the uses directive, line 690
;
; 3. Added to WriteString rax in the uses directive, line 744
...
.code
	...
	push rdx						; added by Adrian Nastase 8/26/2014
	call  ReadConsoleA
	pop rdx							; added by Adrian Nastase 8/26/2014
...
;-----------------------------------------------------
WriteInt64 PROC uses rax rbx rcx rdi
...
; Returns: nothing
;--------------------------------------------------------
WriteString proc uses rax rcx rdx r8 r9
